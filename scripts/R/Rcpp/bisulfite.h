 ...
 * D => [CG] -> [YG]
 * 
 * [TBD]: Should just be a simple search/replace in mutate_seq
 * 
 */

// Dream (TAPS) Conversions::
// static _c drmX_vec[256];
static _c drmM_vec[256];

static _c drmU1_vec[256][256][2];
static _c drmU2_vec[256];
// static _c drmD1_vec[256][256][2];
// static _c drmD2_vec[256];
...
// Init Bisulfite Conversion Flaggs::
...
// Init Dream Flags::
// static _Y init_drmX = false;
static _Y init_drmM = false;
static _Y init_drmU = false;
// static _Y init_drmD = false;
...
/* ***** ***** ***** ***** ***** ***** | ***** ***** ***** ***** ***** ***** 
 * 
 *                  Unmethylated Bisulfite Conversion Table::
 * 
 * ***** ***** ***** ***** ***** ***** | ***** ***** ***** ***** ***** ***** */
...
/* ***** ***** ***** ***** ***** ***** | ***** ***** ***** ***** ***** ***** 
 * 
 *                  Methylated Dream (TAPS) Conversion Table::
 * 
 * ***** ***** ***** ***** ***** ***** | ***** ***** ***** ***** ***** ***** */

static void drmM_init() {
  ...
  drmM_vec[ (_B) 'C'] = 'c'; drmM_vec[ (_B) 'c'] = 'c';
  drmM_vec[ (_B) 'Y'] = 'y'; drmM_vec[ (_B) 'y'] = 'y';
  drmM_vec[ (_B) 'S'] = 's'; drmM_vec[ (_B) 's'] = 's';
  drmM_vec[ (_B) 'M'] = 'm'; drmM_vec[ (_B) 'm'] = 'm';
  drmM_vec[ (_B) 'B'] = 'b'; drmM_vec[ (_B) 'b'] = 'b';
  drmM_vec[ (_B) 'H'] = 'h'; drmM_vec[ (_B) 'h'] = 'h';
  drmM_vec[ (_B) 'V'] = 'v'; drmM_vec[ (_B) 'v'] = 'v';
  drmM_vec[ (_B) 'N'] = 'N'; drmM_vec[ (_B) 'n'] = 'n';
...
/* ***** ***** ***** ***** ***** ***** | ***** ***** ***** ***** ***** ***** 
 * 
 *                   Methylated Bisulfite Conversion Table::
 * 
 * ***** ***** ***** ***** ***** ***** | ***** ***** ***** ***** ***** ***** */
...
static void drmU_init() {
  ...
  for (_I ii = 0; ii < 256; ii++) {
    for (_I jj = 0; jj < 256; jj++) {
      for (_I kk = 0; kk < 2; kk++) {
        if (kk == 0) drmU1_vec[ii][jj][kk] = (_B) ii;
        if (kk == 1) drmU1_vec[ii][jj][kk] = (_B) jj;
      }
    }
  }
  
  drmU1_vec[ (_B) 'C' ][  (_B) 'G' ][0] = 'c';
  drmU1_vec[ (_B) 'C' ][  (_B) 'G' ][1] = 'G';
  drmU1_vec[ (_B) 'C' ][  (_B) 'R' ][0] = 'c';
  drmU1_vec[ (_B) 'C' ][  (_B) 'R' ][1] = 'R';
  drmU1_vec[ (_B) 'C' ][  (_B) 'S' ][0] = 'c';
  drmU1_vec[ (_B) 'C' ][  (_B) 'S' ][1] = 'S';
  drmU1_vec[ (_B) 'C' ][  (_B) 'K' ][0] = 'c';
  drmU1_vec[ (_B) 'C' ][  (_B) 'K' ][1] = 'K';
  drmU1_vec[ (_B) 'C' ][  (_B) 'B' ][0] = 'c';
  drmU1_vec[ (_B) 'C' ][  (_B) 'B' ][1] = 'B';
  drmU1_vec[ (_B) 'C' ][  (_B) 'D' ][0] = 'c';
  drmU1_vec[ (_B) 'C' ][  (_B) 'D' ][1] = 'D';
  drmU1_vec[ (_B) 'C' ][  (_B) 'V' ][0] = 'c';
  drmU1_vec[ (_B) 'C' ][  (_B) 'V' ][1] = 'V';
  
  drmU1_vec[ (_B) 'Y' ][  (_B) 'G' ][0] = 'y';
  drmU1_vec[ (_B) 'Y' ][  (_B) 'G' ][1] = 'G';
  drmU1_vec[ (_B) 'Y' ][  (_B) 'R' ][0] = 'y';
  drmU1_vec[ (_B) 'Y' ][  (_B) 'R' ][1] = 'R';
  drmU1_vec[ (_B) 'Y' ][  (_B) 'S' ][0] = 'y';
  drmU1_vec[ (_B) 'Y' ][  (_B) 'S' ][1] = 'S';
  drmU1_vec[ (_B) 'Y' ][  (_B) 'K' ][0] = 'y';
  drmU1_vec[ (_B) 'Y' ][  (_B) 'K' ][1] = 'K';
  drmU1_vec[ (_B) 'Y' ][  (_B) 'B' ][0] = 'y';
  drmU1_vec[ (_B) 'Y' ][  (_B) 'B' ][1] = 'B';
  drmU1_vec[ (_B) 'Y' ][  (_B) 'D' ][0] = 'y';
  drmU1_vec[ (_B) 'Y' ][  (_B) 'D' ][1] = 'D';
  drmU1_vec[ (_B) 'Y' ][  (_B) 'V' ][0] = 'y';
  drmU1_vec[ (_B) 'Y' ][  (_B) 'V' ][1] = 'V';
  
  drmU1_vec[ (_B) 'S' ][  (_B) 'G' ][0] = 's';
  drmU1_vec[ (_B) 'S' ][  (_B) 'G' ][1] = 'G';
  drmU1_vec[ (_B) 'S' ][  (_B) 'R' ][0] = 's';
  drmU1_vec[ (_B) 'S' ][  (_B) 'R' ][1] = 'R';
  drmU1_vec[ (_B) 'S' ][  (_B) 'S' ][0] = 's';
  drmU1_vec[ (_B) 'S' ][  (_B) 'S' ][1] = 'S';
  drmU1_vec[ (_B) 'S' ][  (_B) 'K' ][0] = 's';
  drmU1_vec[ (_B) 'S' ][  (_B) 'K' ][1] = 'K';
  drmU1_vec[ (_B) 'S' ][  (_B) 'B' ][0] = 's';
  drmU1_vec[ (_B) 'S' ][  (_B) 'B' ][1] = 'B';
  drmU1_vec[ (_B) 'S' ][  (_B) 'D' ][0] = 's';
  drmU1_vec[ (_B) 'S' ][  (_B) 'D' ][1] = 'D';
  drmU1_vec[ (_B) 'S' ][  (_B) 'V' ][0] = 's';
  drmU1_vec[ (_B) 'S' ][  (_B) 'V' ][1] = 'V';
  
  drmU1_vec[ (_B) 'M' ][  (_B) 'G' ][0] = 'm';
  drmU1_vec[ (_B) 'M' ][  (_B) 'G' ][1] = 'G';
  drmU1_vec[ (_B) 'M' ][  (_B) 'R' ][0] = 'm';
  drmU1_vec[ (_B) 'M' ][  (_B) 'R' ][1] = 'R';
  drmU1_vec[ (_B) 'M' ][  (_B) 'S' ][0] = 'm';
  drmU1_vec[ (_B) 'M' ][  (_B) 'S' ][1] = 'S';
  drmU1_vec[ (_B) 'M' ][  (_B) 'K' ][0] = 'm';
  drmU1_vec[ (_B) 'M' ][  (_B) 'K' ][1] = 'K';
  drmU1_vec[ (_B) 'M' ][  (_B) 'B' ][0] = 'm';
  drmU1_vec[ (_B) 'M' ][  (_B) 'B' ][1] = 'B';
  drmU1_vec[ (_B) 'M' ][  (_B) 'D' ][0] = 'm';
  drmU1_vec[ (_B) 'M' ][  (_B) 'D' ][1] = 'D';
  drmU1_vec[ (_B) 'M' ][  (_B) 'V' ][0] = 'm';
  drmU1_vec[ (_B) 'M' ][  (_B) 'V' ][1] = 'V';
  
  drmU1_vec[ (_B) 'B' ][  (_B) 'G' ][0] = 'b';
  drmU1_vec[ (_B) 'B' ][  (_B) 'G' ][1] = 'G';
  drmU1_vec[ (_B) 'B' ][  (_B) 'R' ][0] = 'b';
  drmU1_vec[ (_B) 'B' ][  (_B) 'R' ][1] = 'R';
  drmU1_vec[ (_B) 'B' ][  (_B) 'S' ][0] = 'b';
  drmU1_vec[ (_B) 'B' ][  (_B) 'S' ][1] = 'S';
  drmU1_vec[ (_B) 'B' ][  (_B) 'K' ][0] = 'b';
  drmU1_vec[ (_B) 'B' ][  (_B) 'K' ][1] = 'K';
  drmU1_vec[ (_B) 'B' ][  (_B) 'B' ][0] = 'b';
  drmU1_vec[ (_B) 'B' ][  (_B) 'B' ][1] = 'B';
  drmU1_vec[ (_B) 'B' ][  (_B) 'D' ][0] = 'b';
  drmU1_vec[ (_B) 'B' ][  (_B) 'D' ][1] = 'D';
  drmU1_vec[ (_B) 'B' ][  (_B) 'V' ][0] = 'b';
  drmU1_vec[ (_B) 'B' ][  (_B) 'V' ][1] = 'V';
  
  drmU1_vec[ (_B) 'H' ][  (_B) 'G' ][0] = 'h';
  drmU1_vec[ (_B) 'H' ][  (_B) 'G' ][1] = 'G';
  drmU1_vec[ (_B) 'H' ][  (_B) 'R' ][0] = 'h';
  drmU1_vec[ (_B) 'H' ][  (_B) 'R' ][1] = 'R';
  drmU1_vec[ (_B) 'H' ][  (_B) 'S' ][0] = 'h';
  drmU1_vec[ (_B) 'H' ][  (_B) 'S' ][1] = 'S';
  drmU1_vec[ (_B) 'H' ][  (_B) 'K' ][0] = 'h';
  drmU1_vec[ (_B) 'H' ][  (_B) 'K' ][1] = 'K';
  drmU1_vec[ (_B) 'H' ][  (_B) 'B' ][0] = 'h';
  drmU1_vec[ (_B) 'H' ][  (_B) 'B' ][1] = 'B';
  drmU1_vec[ (_B) 'H' ][  (_B) 'D' ][0] = 'h';
  drmU1_vec[ (_B) 'H' ][  (_B) 'D' ][1] = 'D';
  drmU1_vec[ (_B) 'H' ][  (_B) 'V' ][0] = 'h';
  drmU1_vec[ (_B) 'H' ][  (_B) 'V' ][1] = 'V';
  
  drmU1_vec[ (_B) 'V' ][  (_B) 'G' ][0] = 'v';
  drmU1_vec[ (_B) 'V' ][  (_B) 'G' ][1] = 'G';
  drmU1_vec[ (_B) 'V' ][  (_B) 'R' ][0] = 'v';
  drmU1_vec[ (_B) 'V' ][  (_B) 'R' ][1] = 'R';
  drmU1_vec[ (_B) 'V' ][  (_B) 'S' ][0] = 'v';
  drmU1_vec[ (_B) 'V' ][  (_B) 'S' ][1] = 'S';
  drmU1_vec[ (_B) 'V' ][  (_B) 'K' ][0] = 'v';
  drmU1_vec[ (_B) 'V' ][  (_B) 'K' ][1] = 'K';
  drmU1_vec[ (_B) 'V' ][  (_B) 'B' ][0] = 'v';
  drmU1_vec[ (_B) 'V' ][  (_B) 'B' ][1] = 'B';
  drmU1_vec[ (_B) 'V' ][  (_B) 'D' ][0] = 'v';
  drmU1_vec[ (_B) 'V' ][  (_B) 'D' ][1] = 'D';
  drmU1_vec[ (_B) 'V' ][  (_B) 'V' ][0] = 'v';
  drmU1_vec[ (_B) 'V' ][  (_B) 'V' ][1] = 'V';
...
/* ***** ***** ***** ***** ***** ***** | ***** ***** ***** ***** ***** ***** 
 * 
 *                   Degenerate Bisulfite Conversion Table::
 * 
 * ***** ***** ***** ***** ***** ***** | ***** ***** ***** ***** ***** ***** */
