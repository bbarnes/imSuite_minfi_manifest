...
if [ -e ${RSCRIPT_A} ]; then
    ...
    OUT_DIR="${TOP_DIR}/data/improbe/scratch/cgnDB/dbSNP_Core4/design-output/prbs-P49-split-3.64"

elif [ -e ${RSCRIPT_C} ]; then
    RSCRIPT=${RSCRIPT_C}
    TOP_DIR="/illumina/scratch/darkmatter"
    DAT_DIR="${TOP_DIR}/scratch/improbe/cgnDB/dbSNP_Core4/prbs-p49"
    OUT_DIR="${TOP_DIR}/scratch/improbe/cgnDB/dbSNP_Core4/prbs-P49-split-3.64"
...
NUCS="AAA AAC AAG AAT ACA ACC ACG ACT AGA AGC AGG AGT ATA ATC ATG ATT"
